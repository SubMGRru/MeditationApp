...
public class AuthProposal extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    TranslateAnimation animate_forTitle =
        new TranslateAnimation(0, authproposal_title.getWidth(), 0, 0);
    ...
    TranslateAnimation animate_forSubtitle =
        new TranslateAnimation(0, authproposal_subtitle.getWidth(), 0, 0);
